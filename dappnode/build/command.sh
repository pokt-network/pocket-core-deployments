...
"Only Ethereum Mainnet")
    ...
    [{
        "id": "0021",
        "url": "http://geth.dnp.dappnode.eth:8545"
    }]
EOF
...
"Ethereum mainnet and Pocket mainnet")
    ...
    if [[ "${TLS_OPTION}" == "Do not use a certificate" ]]; then
        cat >/home/app/.pocket/config/chains.json <<EOF
        [{
            "id": "0001",
...
"I have a certificate")
    sed -ie s/\"rpc_port\"\.\*/\"rpc_port\"\:\ \"8082\",/ /home/app/.pocket/config/config.json
