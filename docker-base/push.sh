...
# Run docker build!
BUILD_COMMAND="docker build --build-arg GOLANG_IMAGE_VERSION=golang:$GOLANG_VERSION-alpine --build-arg BRANCH_NAME=$BRANCH_NAME -t pocket-core-$DOCKER_TAG:$DOCKER_TAG docker-base/Dockerfile docker-base/."
eval $BUILD_COMMAND
